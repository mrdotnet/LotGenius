...
/**
 * The original SC4 photo-pen classification-review lane: surface strangers
 * (lots whose neighbors disagree), select them, dry-run the override, and
 * commit with an optimistic reflow + Undo receipt. Unchanged behavior, lifted
 * out of App so it can live behind the Review tab alongside the admin views.
 */
export function ReviewView({ api }: ReviewViewProps) {
