...
COMMON_VOICES=(
  "en_US-ryan-high"          # Default, expressive male (30MB) - SPT: John (pm)
  "en_US-amy-medium"         # Warm female (13MB) - SPT: Mary (analyst)
  "en_US-hfc_female-medium"  # Professional female (13MB) - SPT: Amelia (dev)
  "en_US-lessac-medium"      # Clear female (13MB) - SPT: Murat (tea) - NOTE: Female voice
  "en_US-danny-low"          # Calm male (13MB) - SPT: Winston (architect)
  "en_US-bryce-medium"       # Professional male (13MB) - SPT: Hearth (sm)
  "en_US-kathleen-low"       # Clear female (13MB) - SPT: Paige (tech-writer)
  "en_US-kusal-medium"       # Male voice (13MB) - SPT: Saif (frame-expert)
  "en_US-kristin-medium"     # Female voice (13MB) - SPT: Sally (ux-designer)
  "en_US-libritts_r-high"    # Premium male (57MB) - SPT: SPT Master
  "en_US-libritts-high"      # Premium quality (57MB)
  "16Speakers"               # Multi-speaker: 12 US + 4 UK voices (77MB) - REQUIRED for SPT agents
)
